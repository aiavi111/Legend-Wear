...
const dict = {
  ru: {
    ...
    cart: {
      ...
      scan: 'Отсканируйте QR и оплатите', payHint: 'Прикрепите чек и нажмите кнопку — заказ улетит нам.',
      paid: 'Я оплатил(а) — отправить заказ', sending: 'Отправляю…',
      receipt: 'Чек об оплате', attach: 'Прикрепить скрин чека', change: 'Заменить чек', receiptHint: 'Необязательно, но так мы подтвердим заказ быстрее', tooBig: 'Файл слишком большой (максимум 6 МБ)',
  ...
  ky: {
    ...
    cart: {
      ...
      scan: 'QR-кодду скандап, төлөңүз', payHint: 'Чекти тиркеп, баскычты басыңыз — заказ бизге келет.',
      paid: 'Төлөдүм — заказды жөнөтүү', sending: 'Жөнөтүлүүдө…',
      receipt: 'Төлөм чеги', attach: 'Чектин скринин тиркөө', change: 'Чекти алмаштыруу', receiptHint: 'Милдеттүү эмес, бирок заказды тезирээк ырастайбыз', tooBig: 'Файл өтө чоң (эң көбү 6 МБ)',
  ...
  en: {
    ...
    cart: {
      ...
      scan: 'Scan the QR and pay', payHint: 'Attach the receipt and tap the button — we get your order instantly.',
      paid: 'I have paid — send order', sending: 'Sending…',
      receipt: 'Payment receipt', attach: 'Attach receipt screenshot', change: 'Change receipt', receiptHint: 'Optional, but it speeds up confirmation', tooBig: 'File is too large (max 6 MB)',
